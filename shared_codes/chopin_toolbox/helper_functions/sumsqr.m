...
%
%  [S,N] = <a href="matlab:doc sumsqr">sumsqr</a>(X) returns the sum, S, of the squared values of all
%  finite elements in X, and the number of finite elements, N.  X may be a
%  numeric matrix or a cell array of numeric matrices.
%
%  For example:
%
